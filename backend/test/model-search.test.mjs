...
test('model search emits opaque discovery results and can consume only its verified binding', async () => {
  ...
  const provider = createModelSearchProvider({
    ...
    executeRemote: async ({ script }) => {
      receivedScript = script;
      return ['/home/test/ai/models/vision/vision-model-8b-fp8', '/home/test/ai/models/text/translator-model-30b-fp8', '/home/test/.cache/huggingface/hub/models--Example--Text-8B'].join('\n');
    },
  });
  ...
  assert.match(receivedScript, /! -name '\.\*'/);
